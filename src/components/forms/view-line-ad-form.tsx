...
export function ViewLineAdDetails({ adId }: { adId: string }) {
        ...
        <div className="flex items-center justify-between pb-2 border-b">
          <div className="flex items-center gap-2">
            <Button
              variant="ghost"
              size="sm"
              onClick={() => router.push("/dashboard/my-ads/line-ads")}
                ...
                {ad.images.length > 0 ? (
                  <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2">
                    {ad.images.map((image, index) => (
                      <Zoom key={image.id}>
                        <div className="aspect- w-60 border rounded overflow-hidden bg-gray-50 hover:shadow-md transition-shadow cursor-pointer">
                          <img
                  ...
                  <div className="flex flex-col items-center justify-center h-20 border-2 border-dashed rounded bg-gray-50">

...
export const columns: ColumnDef<PosterAd>[] = [
  {
    ...
    cell: ({ row }) => {
      ...
      return <div className="font-medium">PA00{sequenceNumber}</div>;
    },
  },
  {
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <div
          key={image.id}
          className="size-10 relative aspect-square overflow-hidden rounded-md border"
        >
          <Zoom>
            <Image
      ...
      return (
        <div className="flex items-center gap-2 justify-end">
          <Button variant="ghost" size="icon" className="h-8 w-8" asChild>
            <Link href={`/mgmt/dashboard/review-ads/poster/view/${ad.id}`}>
